...
geolocation_button = driver.find_element_by_xpath('/html[1]/body[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/a[1]/i[1]')
geolocation_button.click()
time.sleep(5)
# geolocation_city = driver.find_element_by_xpath('/html[1]/body[1]/div[10]/div[1]/div[1]')
# geolocation_city.click()

actions = ActionChains(driver)
actions.move_by_offset(10, 200).click()
actions.perform()
